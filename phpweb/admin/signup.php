...
<form method="post">
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control" id="floatingInput" name="emailaddress">
...
$sql="INSERT INTO `sign`(`username`, `emailaddress`, `password`) VALUES ('$username','$emailaddress','$password')";
